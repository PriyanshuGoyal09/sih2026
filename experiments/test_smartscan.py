...
def main():
    ...
    print("\n" + "=" * 45)
    print(" SMARTSCAN UCB EXPERIMENT")
    print("=" * 45)
    ...
    for t in range(
        ...
        for scan_index in range(
            ...
            # IMPORTANT:
            # Only receiver output goes back to scheduler.
            scheduler.update(
                band=band,
    ...
    for item in stats:
        ...
        print(
            ...
            f"| reward={item['reward']:6.2f} "
            f"| avg={item['average_reward']:.3f}"
        )
